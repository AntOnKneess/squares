...
class Trail():
    def __init__(self, x=40, y=40, speed = 3.25, w = 25, h=25, roundness = 10, color=(255,255,255), lifetime = 20, fade=5, direction = (0,180), density = 10, fadedel = 20, scw = 1920, sch = 1080):
        super().__init__()
        self.x =x
        self.y = y
        self.speed = speed
